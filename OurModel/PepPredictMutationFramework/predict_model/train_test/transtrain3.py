...
for n_heads in range(1, 10):
    for fold, (train_index, val_index) in enumerate(kf.split(train_pep_tcr_loader.dataset)):
        ...
        dir_saver = './transformer/model_3layers/'
        path_saver = './transformer/model_3layers/model_pt_layer{}_head{}_fold{}.pth'.format(n_layers, n_heads, fold)
...
for n_heads in range(1, 10):
    for fold in range(5):
        ...
        dir_saver = './transformer/model_3layers/'
        path_saver = './transformer/model_3layers/model_hp_layer{}_head{}_fold{}.pth'.format(n_layers, n_heads, fold)
