...
from predict_model.loader.DataGenerater import *
from predict_model.retnet.retnet.RetNet import RetNet
...
for n_layers in range(1, 10):
    for n_heads in range(1, 10):
        for fold, (train_index, val_index) in enumerate(kf.split(train_pep_tcr_loader.dataset)):
            ...
            dir_saver = '../predict_model/retnet/model/'
            path_saver = './retnet/model/model_pt_layer{}_head{}_fold{}.pth'.format(n_layers, n_heads, fold)
...
for n_layers in range(1, 10):
    for n_heads in range(1, 10):
        for fold in range(5):
            ...
            dir_saver = '../predict_model/retnet/model/'
            path_saver = './retnet/model/model_hp_layer{}_head{}_fold{}.pth'.format(n_layers, n_heads, fold)
